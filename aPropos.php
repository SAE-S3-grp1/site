...
<section>
    ...
    <div>
        ...
        <p>Passionné par l’informatique et le travail d’équipe, Enzo est un leader naturel. Il est motivé par l’idée de créer un cadre où chaque étudiant peut s’épanouir. Toujours à l'écoute, il s'assure que toutes les voix sont entendues et que nos projets reflètent les attentes de nos membres.</p>
        <img src="assets/photo_enzo.png" alt="Photo de Enzo Rynders--Vitu" />
    </div>

    <div>
        <p>Tom, le Comptable : </p>
        <p>Avec un œil attentif aux détails et une grande rigueur, Tom gère nos finances avec sérieux. Sa motivation vient de son désir d’optimiser les ressources pour que chaque événement soit un succès. Il sait que la bonne gestion est la clé de notre développement.</p>
        <img src="assets/photo_tom.png" alt="Photo de Tom Ysope" />
    </div>

    <div>
        <p>Mathis, Chargé de communication : </p>
        <p>Toujours à la recherche de nouvelles façons de communiquer, Mathis a un talent pour la cuisine et la création de contenu. Sa motivation est de faire briller notre BDE et d'informer les étudiants sur nos activités. Il utilise les réseaux sociaux pour créer une véritable communauté en ligne.</p>
        <img src="assets/photo_mathis.png" alt="Photo de Mathis Le Nôtre" />
    </div>

    <div>
        <p>Gémino, Secrétaire : </p>
        <p>Gémino joue un rôle essentiel dans le bon fonctionnement du BDE. Sa motivation réside dans le fait de s'assurer que tout est bien structuré, de la prise de notes lors des réunions à la gestion des documents administratifs. Il aime voir les choses s'organiser efficacement.</p>
        <img src="assets/photo_gemino.png" alt="Photo de Gemino Ruffault--Ravenel" />
    </div>

    <div>
        <p>Axel & Julien, Membres : </p>
