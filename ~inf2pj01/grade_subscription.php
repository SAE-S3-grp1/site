...
<head>
    ...
    <link rel="stylesheet" href="~inf2pj01/styles/grade_subscription_style.css">
...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header("Location: ~inf2pj01/grade.php");
    exit;
}
...
<div>
    ...
    <div>    
        ...
        <div id="carte_credit" class="mode_paiement_fields">
            <form method="POST" action="~inf2pj01/grade_subscription.php?id=<?= $id_grade ?>">
